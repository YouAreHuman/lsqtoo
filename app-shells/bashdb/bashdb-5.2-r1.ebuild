...
SRC_URI="https://github.com/rocky/bashdb/archive/refs/heads/${PN:0:4}-${PV}.tar.gz -> ${MY_P}.tar.gz
...
src_prepare() {
	...
	sed -i 's:texi2html:true:' doc/Makefile.am || die
	#sed -i "2793s:0.):1\' | \'5\.2\'):" configure || die
}
