...
src_configure() {
	...
	cf="./configure --prefix=/usr --mandir=/usr/share/man --infodir=/usr/share/info --datadir=/usr/share --sysconfdir=/etc --localstatedir=/var/lib --disable-dependency-tracking --disable-silent-rules --docdir=/usr/share/doc/dante-1.4.3 --htmldir=/usr/share/doc/dante-1.4.3/html --with-sysroot=/ --libdir=/usr/lib64 \
...
src_install() {
	...
	# init script
	newinitd "${FILESDIR}"/${PN}-1.4.3-sockd-init dante-sockd
