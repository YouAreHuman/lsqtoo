...
src_prepare() {
	...
	sed -i -E 's|(stddef.h>)$|\1\n#include <string>|' "include/grpc/event_engine/memory_request.h" || die
	sed -i -E 's|(string>)$|\1\n#include <limits>|' "src/core/channelz/v2tov1/property_list.cc" || die
	sed -i -E 's|(string_view.h")$|\1\n#include <algorithm>|' "src/core/util/glob.cc" || die
